...
@Achievement
object BlindingLightsAchievement : NumericAchievement() {
    override val id: String = "blinding_lights"
    override val name: String = "Blinding Lights"
    override val description: String = "Drop 2 Flash 1 books back-to-back (Counts if you're close to a thunder)"
    ...
    private val SEA_CREATURE by lazy { SeaCreatures.get("Thunder") }
    private val DROP = RareDrops.FLASH_BOOK
    private val foundThunders: MutableSet<SkyblockEntity> = mutableSetOf()
    ...
    override fun setupListeners() {
        ...
        activeListeners.add(registerMobDisposeEvent { entities ->
            entities.forEach { entity ->
                if (foundThunders.remove(entity) &&
