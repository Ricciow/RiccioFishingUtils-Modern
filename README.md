...
RiccioFishingUtils is a Fabric Mod for Minecraft 26.1.x and 26.2 that adds many useful features to [Hypixel SkyBlock](https://wiki.hypixel.net/Fishing) focused mostly on fishing.
